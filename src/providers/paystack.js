...
async function createCustomer({
  ...
  if (!email) {
    throw new Error("PAYSTACK_CUSTOMER_EMAIL_REQUIRED");
  }
...
async function getCustomer(identifier) {
  if (!identifier) {
    throw new Error("PAYSTACK_CUSTOMER_IDENTIFIER_REQUIRED");
  }
...
async function updateCustomer(
  ...
  if (!customerCode) {
    throw new Error("PAYSTACK_CUSTOMER_CODE_REQUIRED");
  }
 ...
 *
 * customer can be a Paystack customer code or ID.
 */
...
/**
 * Fetch a Dedicated Virtual Account by its Paystack ID.
 */
 ...
 *
 * customer can be a Paystack customer ID/code.
 */
...
/**
 * Get the banks currently available for Dedicated
 * Virtual Accounts.
 */
 ...
 *
 * This will be used for payment verification/reconciliation.
 */
